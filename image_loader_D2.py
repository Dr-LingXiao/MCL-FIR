...
class TripletImageLoader(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        c_text0 = self.triplets[index][5]
        c_text1 = self.triplets[index][6]
        ...
        return img1, img2, img3, c, c_text, c_text0, c_text1, img11, img22, img33
...
class ImageLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, root, base_path, filenames_filename, split, cand_query, task_id, CLIP_text, CLIP_text0,
        ...
        ################################
        self.category = self.meta.data['ATTRIBUTES']
        self.attributes = [i for i in range(len(self.category))]
