...
class TripletGenerator_D(object):
...
class TripletImageLoader_D(torch.utils.data.Dataset):
    ...
    def __init__(self, root, base_path, num_triplets, CLIP_text, transform=None,
        ...
        self.meta = MetaLoader_D(self.root, self.base_path)
        self.CLIP_text = CLIP_text
        self.triplet_generator = TripletGenerator_D(self.root, self.base_path, self.meta.data, self.CLIP_text)
...
class ImageLoader_D(torch.utils.data.Dataset):
